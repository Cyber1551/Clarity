...
use crate::image_helpers::is_image_file;
use crate::models::MediaItem;
use crate::video_helpers::{get_video_duration, is_video_file};
...
fn create_media_item(id: i64, path: &str) -> Option<MediaItem> {
    ...
    let length = get_video_duration(path); // Placeholder for video length
